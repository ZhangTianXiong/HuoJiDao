...
#import "TXVideoTableVieCell.h"

@implementation TXVideoTableVieCell
...
-(instancetype)initWithTableView:(UITableView *)tableView
{
    ...
    TXVideoTableVieCell * cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell)
    {
        cell = [[TXVideoTableVieCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return cell;
}

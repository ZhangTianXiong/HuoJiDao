...
@implementation TXRecommendTableViewCell
...
-(void)setFramemodel:(TXListFrameModel *)framemodel
{
    ...
    [_picture sd_setImageWithURL:[NSURL URLWithString:_framemodel.model.img] placeholderImage:[UIImage imageNamed:@"turkey"]];
...
{
    static  NSString * ID = @"recommend_cell";
    TXRecommendTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell)
    {
        cell = [[TXRecommendTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return cell;
}

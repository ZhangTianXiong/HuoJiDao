...
@interface TXUserAllViewController ()
<
...
@implementation TXUserAllViewController
-(void)initVar
{
    _pag    = 2;
    _number = 20;
...
-(void)addAllTableView
{
    ...
    CGFloat allTableViewY  = 0;
    CGFloat allTableViewW  = self.view.frame.size.width;
    CGFloat allTableViewH  = self.view.frame.size.height-104;

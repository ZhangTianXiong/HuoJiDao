...
@implementation TXSearchTableViewCell
...
-(instancetype)initWithTableView:(UITableView *)tableView
{
    ...
    TXSearchTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell)
    {
        cell = [[TXSearchTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return cell;
}

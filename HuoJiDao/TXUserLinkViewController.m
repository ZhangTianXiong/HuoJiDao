...
@interface TXUserLinkViewController ()
<
...
@implementation TXUserLinkViewController
-(void)initVar
{
    _pag        = 2;
    _number     = 3;
...
-(void)addVideoTableView
{
    ...
    CGFloat linkTableViewY       = 0;
    CGFloat linkTableViewW       = self.view.frame.size.width;
    CGFloat linkTableViewH       = self.view.frame.size.height-104;
